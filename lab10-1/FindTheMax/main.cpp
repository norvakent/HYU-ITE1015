...
public:
  ...
  double get_perimeter() override { return 2 * PI * m_radius; }
};
...
public:
  ...
  double get_perimeter() override { return 4 * m_side; }
};
...
public:
  ...
  double get_perimeter() override { return 3 * m_side; }
};

int main() {
  Shape *shapes[3] = {new Circle("circle", 3), new Square("square", 4),
                      new RegularTriangle("regular_triangle", 5)};

  Shape *maxObj = nullptr;
  string maxName;
  int maxIdx = -1;
  double maxVal = -1;
  double perimeter;
